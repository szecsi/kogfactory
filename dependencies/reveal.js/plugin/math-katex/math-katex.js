...
window.RevealMath = window.RevealMath || (function() {
	...
	options.katexScript     = options.katexScript     || 'plugin/math-katex/lib/katex-0.7.1/katex.min.js';
	options.katexStylesheet = options.katexStylesheet || 'plugin/math-katex/lib/katex-0.7.1/katex.min.css';
	...
	var defaults = {
		...
		// found
		cdn: {
			script:     'https://cdnjs.cloudflare.com/ajax/libs/KaTeX/0.7.1/katex.min.js',
			stylesheet: 'https://cdnjs.cloudflare.com/ajax/libs/KaTeX/0.7.1/katex.min.css'
		},
